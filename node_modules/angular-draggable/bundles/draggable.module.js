...
System.registerDynamic('draggable.module', ['@angular/core', './draggable.directive'], true, function ($__require, exports, module) {
    ...
    var NgDraggableModule = function () {
        function NgDraggableModule() {}
        NgDraggableModule.decorators = [{ type: core_1.NgModule, args: [{
                imports: [],
                declarations: [draggable_directive_1.DraggableDirective],
                exports: [draggable_directive_1.DraggableDirective],
                providers: []
            }] }];
        NgDraggableModule.ctorParameters = function () {
            return [];
        };
        return NgDraggableModule;
    }();
    exports.NgDraggableModule = NgDraggableModule;
});